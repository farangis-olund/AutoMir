namespace NickBuhro.NumToWords.Russian
{
    ...
    public sealed class UnitOfMeasure
    {
        ...
        /// </summary>
        public static readonly UnitOfMeasure Ruble = new UnitOfMeasure(Gender.Masculine, "сомони", "сомони", "сомони");
        
        /// <summary>
        /// Definition of kopek - cent equivalent for rubles.
        /// </summary>
        public static readonly UnitOfMeasure Kopek = new UnitOfMeasure(Gender.Feminine, "дирам", "дирам", "дирам");
